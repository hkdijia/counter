package com.gotkx.counter.service;
...
import com.gotkx.counter.util.JsonUtil;
import com.gotkx.counter.util.TimeformatUtil;
...
public class AccountServiceImpl implements AccountService {
    ...
    public Account login(long uid, String password, String captcha, String captchaId) throws Exception {
        ...
        if (account == null) {
            ...
            //存入缓存
            RedisStringCache.cache(
                    String.valueOf(account.getToken()),
